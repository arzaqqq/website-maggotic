  ...
  <div class="hero min-h-screen">
    <div class="hero-content flex-col lg:flex-row-reverse px-28">
      <div class="flex flex-col items-center">
        <img src="<?= base_url('img/produktestimoni.png') ?>" class="max-w-sm rounded-lg mr-24" />
        <a href="<?= base_url('testimoni') ?>" class=" btn-test bg-maggotic ml-16 px-20 py-3  rounded-lg font-semibold text-white text-center hover:bg-gray-300 duration-200 hover:scale-110 hover:text-black">
          Lihat Testimoni
        </a>
      </div>
      <div class="ml-20">
