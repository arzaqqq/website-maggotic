...
<div class="container mx-auto mt-8 mb-24 px-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <!-- Card 1 -->
        <div
            class="card w-full h-[542px] shadow-lg transition duration-300 ease-in-out transform hover:shadow-2xl hover:scale-105">
            <figure>
            ...
            <div class="card-body text-black px-4 py-5">
                ...
                <div class="card-actions flex justify-end mt-4">
                    <button
                        class="px-4 py-2 rounded-full border-2 border-stone-950 transition duration-300 ease-in-out transform hover:bg-blue-600 hover:text-white">Selengkapnya</button>
                </div>
            </div>
        </div>
